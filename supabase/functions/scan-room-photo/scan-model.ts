import { sanitizeSceneDescription } from "../_shared/description-sanitizer.ts";
...
export function scanModelForMode(
  mode: ScanMode,
...
export function sanitizeScannedItem<T extends { description?: string | null }>(
  item: T,
): T & { description: string } {
  return {
    ...item,
    description: sanitizeSceneDescription(item.description, 600),
  };
}
